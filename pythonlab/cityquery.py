...
def test_query_one_1():
    ...
    sql = "SELECT city FROM uspop1k WHERE cities = 'Northfield' "
...
def test_query_one_3():
    ...
    sql_least_MN_city = """SELECT city FROM uspop1k WHERE cities = 'MN' ORDER BY pop ASC
             LIMIT 1;"""
...
def test_query_all_4():
    ...
    sql_directions_1 = "SELECT city FROM uspop1k ORDER BY latitude DESC LIMIT 1;"
    cur.execute( sql_directions_1 )
    row_1 = cur.fetchone()
    print("Furthest North: "+row_1)

    sql_directions_2 = "SELECT city FROM uspop1k ORDER BY latitude ASC LIMIT 1;"
    cur.execute( sql_directions_2 )
    row_2 = cur.fetchone()
    print("Furthest South: "+row_2)

    sql_directions_3 = "SELECT city FROM uspop1k ORDER BY longitude DESC LIMIT 1;"
    cur.execute( sql_directions_3 )
    row_3 = cur.fetchone()
    print("Furthest East: "+row_3)

    sql_directions_4 = "SELECT city FROM uspop1k ORDER BY longitude ASC LIMIT 1;"
